 ...
 */
interface puzzle_message_MessageFactoryInterface
{
    /**
     * Creates a response
     *
     ...
     * - body: string|resource|array|puzzle_stream_StreamInterface request body to send
     ...
     * - cookies: true|false|puzzle_cookie_CookieJarInterface To enable or disable cookies
     * - allow_redirects: true|false|array Controls HTTP redirects
     * - save_to: string|resource|puzzle_stream_StreamInterface Where the response is saved
