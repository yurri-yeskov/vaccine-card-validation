...
abstract class puzzle_message_AbstractMessage implements puzzle_message_MessageInterface
{
    ...
    /** @var puzzle_stream_StreamInterface Message body */
    private $body;
    ...
    {
        return self::getStartLineAndHeaders($this)
            . "\r\n\r\n" . $this->getBody();
    }
    ...
    public function setBody(puzzle_stream_StreamInterface $body = null)
    {
        if ($body === null) {
     ...
     *
     * @param puzzle_message_MessageInterface $message That contains the header
     * @param string                                 $header  Header to retrieve from the message
     *
     * @return array Returns the parsed header values.
     */
    public static function parseHeader(puzzle_message_MessageInterface $message, $header)
    {
        static $trimmed = "\"'  \n\t\r";
     ...
     */
    public static function normalizeHeader(puzzle_message_MessageInterface $message, $header)
    {
     ...
     * @return string
     */
    public static function getStartLineAndHeaders(puzzle_message_MessageInterface $message)
    {
        return self::getStartLine($message)
     ...
     * @return string
     */
    public static function getHeadersAsString(puzzle_message_MessageInterface $message)
    {
        $result  = '';
