 ...
 */
interface puzzle_message_MessageInterface
{
    /**
     ...
     *
     * The body MUST be a puzzle_stream_StreamInterface object. Setting the body to null MUST
     * remove the existing body.
     *
     * @param puzzle_stream_StreamInterface|null $body Body.
     *
     * @return self Returns the message.
     */
    function setBody(puzzle_stream_StreamInterface $body = null);

    /**
     * Get the body of the message
     *
     * @return puzzle_stream_StreamInterface|null
     */
    function getBody();
