 ...
 */
class puzzle_message_Response extends puzzle_message_AbstractMessage implements puzzle_message_ResponseInterface
{
     ...
     * @param puzzle_stream_StreamInterface $body       The body of the response
    ...
    public function __construct(
        $statusCode,
        array $headers = array(),
        puzzle_stream_StreamInterface $body = null,
        array $options = array()
    ) {
    ...
    public function json(array $config = array())
    {
        try {
            ...
            throw new puzzle_exception_ParseException(
                $e->getMessage(),
                $this
            );
        }
    ...
    public function xml(array $config = array())
    {
        ...
        try {
            ...
            $xml = new SimpleXMLElement(
                (string) $this->getBody() ? $this->getBody() : '<root />',
