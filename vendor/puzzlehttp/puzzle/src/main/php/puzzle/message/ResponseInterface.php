 ...
 */
interface puzzle_message_ResponseInterface extends puzzle_message_MessageInterface
{
    /**
     ...
     */
    function json(array $config = array());
     ...
     */
    function xml(array $config = array());
}
