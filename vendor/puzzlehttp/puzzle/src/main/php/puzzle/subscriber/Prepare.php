 ...
 */
class puzzle_subscriber_Prepare implements puzzle_event_SubscriberInterface
{
    public function getEvents()
    {
        return array('before' => array('onBefore', puzzle_event_RequestEvents::PREPARE_REQUEST));
    }
    ...
    private function addContentType(
        ...
        puzzle_stream_StreamInterface $body
    ) {
