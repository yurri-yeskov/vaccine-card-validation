...
class puzzle_Url
{
    ...
    /** @var puzzle_Query Query part of the URL */
    private $query;

    /**
     * Factory method to create a new URL from a URL string
     *
     * @param string $url Full URL used to create a puzzle_Url object
     *
     * @return puzzle_Url
    ...
    public static function fromString($url)
    {
        ...
        //leave the @ as PHP < 5.3.3 will throw up a warning
        ...
        // Convert the query string into a puzzle_Query object
     ...
     * @param puzzle_Query|array|string $query    Query string of the URL
    ...
    /**
     * Get the query part of the URL as a puzzle_Query object
     *
     * @return puzzle_Query
     */
