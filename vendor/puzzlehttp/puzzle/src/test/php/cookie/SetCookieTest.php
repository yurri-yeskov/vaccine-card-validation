...
/**
 * @covers puzzle_cookie_SetCookie
 */
class puzzle_test_cookie_SetCookieTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $cookie = new puzzle_cookie_SetCookie(array('Expires' => 'November 20, 1984'));
    ...
    {
        $t = time();
        $cookie = new puzzle_cookie_SetCookie(array('Max-Age' => 100));
    ...
    public function testHoldsValues()
    {
        ...
        $cookie = new puzzle_cookie_SetCookie($data);
        ...
        $this->assertEquals('baz', $cookieArray['foo']);
        $this->assertEquals('bam', $cookieArray['bar']);
    ...
    {
        $cookie = new puzzle_cookie_SetCookie(array(
            'Name'   => $name,
            'Value'  => $value,
            'Domain' => $domain
        ));
