...
/**
 * @covers puzzle_UriTemplate
 */
class puzzle_test_UriTemplateTest extends PHPUnit_Framework_TestCase
{
    private $_closure_templateProvider_params;
    ...
    {
        $this->_closure_templateProvider_params = array(
            'var'   => 'value',
            'hello' => 'Hello World!',
            'empty' => '',
            'path'  => '/foo/bar',
        ...
        return array_map(array($this, '__callback_templateProvider'), array(
            array('foo',                 'foo'),
            array('{var}',               'value'),
    ...
    public function __callback_templateProvider($t)
    {
        $t[] = $this->_closure_templateProvider_params;
        return $t;
    }
    ...
    {
        $uri = new puzzle_UriTemplate($template);
    ...
    {
        $template = new puzzle_UriTemplate($exp);

        // Access the config object
        $class = new ReflectionClass($template);
        $method = $class->getMethod('__parseExpression');
