...
class puzzle_test_stream_LazyOpenStreamTest extends PHPUnit_Framework_TestCase
{
    private $fname;
    ...
    {
        $l = new puzzle_stream_LazyOpenStream($this->fname, 'w+');
        $l->write('foo');
    ...
    public function testProxiesToFile()
    {
        ...
        $l = new puzzle_stream_LazyOpenStream($this->fname, 'r');
