...
/**
 * @covers puzzle_stream_GuzzleStreamWrapper
 */
class puzzle_test_stream_GuzzleStreamWrapperTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $stream = $this->getMockBuilder('puzzle_stream_StreamInterface')
        ...
        $stream->expects($this->once())
            ->method('isWritable')
            ->will($this->returnValue(false));
        puzzle_stream_GuzzleStreamWrapper::getResource($stream);
    }
