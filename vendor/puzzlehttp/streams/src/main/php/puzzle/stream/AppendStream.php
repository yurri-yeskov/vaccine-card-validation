 ...
 */
class puzzle_stream_AppendStream implements puzzle_stream_StreamInterface
{
    /** @var puzzle_stream_StreamInterface[] Streams being decorated */
    ...
    /**
     * @param puzzle_stream_StreamInterface[] $streams Streams to decorate. Each stream must
     *                                   be readable.
     */
