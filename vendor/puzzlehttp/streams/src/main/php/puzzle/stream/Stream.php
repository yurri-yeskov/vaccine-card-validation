 ...
 */
class puzzle_stream_Stream implements puzzle_stream_MetadataStreamInterface
{
    private $stream;
    private $size;
    private $seekable;
     ...
     *
     * @param resource|string|puzzle_stream_StreamInterface $resource Entity body data
    ...
    public static function factory($resource = '', $size = null)
    {
        ...
        if ($resource instanceof puzzle_stream_StreamInterface) {
            return $resource;
        }
