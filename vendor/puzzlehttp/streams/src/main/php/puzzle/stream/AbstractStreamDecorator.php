 ...
 */
abstract class puzzle_stream_AbstractStreamDecorator
{
    /**
     ...
     * the constructor of a decorator (e.g., puzzle_stream_LazyOpenStream).
     */
    ...
    {
        return $this->stream instanceof puzzle_stream_MetadataStreamInterface
